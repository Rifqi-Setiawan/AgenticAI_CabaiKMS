# Frozen annotation campaign runbook

Campaign version: `schema-mapping-validation-campaign-v1`

The authoritative scope is `eval/campaigns/schema-mapping-validation-campaign-v1/manifest.json`. Both annotator workbooks are derived from the same master and manifest. The two repository files whose names contain `sintetis` are not field-validation inputs.

## Package generation

```powershell
.\.venv\Scripts\python.exe eval/prepare_annotation_campaign.py `
  --manifest eval/campaigns/schema-mapping-validation-campaign-v1/manifest.json `
  --output-dir eval/campaigns/schema-mapping-validation-campaign-v1
```
...
.\.venv\Scripts\python.exe eval/validate_mapping_annotations.py `
  --annotations eval/campaigns/schema-mapping-validation-campaign-v1/round1/annotator_A_round1.xlsx `
  --compare eval/campaigns/schema-mapping-validation-campaign-v1/round1/annotator_B_round1.xlsx `
  --pair-only
```
...
.\.venv\Scripts\python.exe eval/validate_mapping_annotations.py `
  --annotations eval/campaigns/schema-mapping-validation-campaign-v1/round1/annotator_A_round1.xlsx `
  --compare eval/campaigns/schema-mapping-validation-campaign-v1/round1/annotator_B_round1.xlsx `
  --disagreements-output eval/campaigns/schema-mapping-validation-campaign-v1/adjudication/disagreements_round1.xlsx
```
...
.\.venv\Scripts\python.exe eval/finalize_mapping_annotations.py `
  --annotations-a eval/campaigns/schema-mapping-validation-campaign-v1/round1/annotator_A_round1.xlsx `
  --annotations-b eval/campaigns/schema-mapping-validation-campaign-v1/round1/annotator_B_round1.xlsx `
  --adjudication eval/campaigns/schema-mapping-validation-campaign-v1/adjudication/disagreements_round1.xlsx `
  --campaign-metadata eval/campaigns/schema-mapping-validation-campaign-v1/metadata.json `
  --output-final eval/campaigns/schema-mapping-validation-campaign-v1/adjudication/adjudicated_validation_gold.xlsx `
  --output-history eval/campaigns/schema-mapping-validation-campaign-v1/adjudication/adjudication_history.json
```
